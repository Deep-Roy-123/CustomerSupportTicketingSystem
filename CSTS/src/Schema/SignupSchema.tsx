...
export const SignupSchema = Yup.object({
  name: Yup.string()
    .matches(
      namex,
      "First letter should be capital both first and last name,one space between them"
    )
  ...
  email: Yup.string()
    .matches(
      emailx,
      "Email should be in small letter,their will be .,%,_,+,@ this special charecter"
    )
  ...
  password: Yup.string()
    .matches(
      passwordex,
      "Password first char should be capital,their will be one @"
    )
